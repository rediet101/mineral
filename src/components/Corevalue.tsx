...
export default function Corevalue() {
  ...
  return (
    <main className="min-h-full text-gray-800 ">
      {/* Header Section */}
      <header className="py-8 md:py-16 px-4 md:px-6">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left column - Explore heading */}
          <div>
            <h1 className="text-6xl md:text-6xl font-bold text-black mb-4 px-4 md:px-0">
              Explore; <br />
              Ethiopia as the <br />
              land of plenty
            </h1>
            <p className="text-sm text-gray-600 w-full">
              with resources found in abundance throughout its huge and diverse
              land mass in our product range.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center md:-ml-20">
            <p className="text-4xl md:text-4xl font-semibold  leading-[1.4]">
              Through experiences and expertise gained we know mining in
              Ethiopia. We consult parties interested in working in the mining
              sector in Ethiopia.
            </p>
          </div>
        </div>
      ...
      <section id="minerals-section" className="pt-25 md:py-12 px-6 relative">
        <div className="container mx-auto">
          <h2 className="text-7xl font-bold mb-12">Our Core Services</h2>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8 md:mb-16 relative">
            <div className="flex flex-col md:flex-row gap-0 flex-1">
              <Link href={"/service"}>
                <Button
                  ...
                  onClick={() =>
                    setActiveService("Minerals Exploration & Development")
                  }
                >
                  Minerals Exploration & Development
                </Button>
              ...
              <Link href={"/service"}>
                <Button
                  ...
                  onClick={() =>
                    setActiveService("Gemstone Production & Retail")
                  }
                >
            ...
            <Link href={"/service"}>
              <Button
                variant="outline"
                className={`rounded-full px-6 md:px-6 py-5 text-xl whitespace-normal md:whitespace-nowrap md:ml-auto ${
...
<div className="flex flex-col md:flex-row gap-6 mt-10">
  {/* Gold Card (larger) */}
  <Link href="/service/gold" className="flex-[1.9] block">
  ...
  {/* Quartz Card */}
  <Link href="/service/quartz" className="flex-1 block">
    <div className="relative overflow-hidden rounded-3xl bg-gray-200 text-white transition-all duration-300 hover:scale-105 hover:z-10 group">
      <div className="relative w-full h-[450px]">
        <img 
          src="/quartz.gif" 
          alt="Quartz mineral"
      ...
      <div className="absolute inset-0 p-8 flex flex-col">
        ...
        <div className="border-t border-white/50 pt-4">
          <div className="flex justify-start">
            <img src="/arcade.svg" alt="" className="w-30 h-26" />
          </div>
        </div>
      </div>
    </div>
  ...
  {/* Feldspar Card */}
  <Link href="/service/feldspar" className="flex-1 block">
    <div className="relative overflow-hidden rounded-3xl bg-black text-white transition-all duration-300 hover:scale-105 hover:z-10 group">
      <div className="relative w-full h-[450px]">
        <img 
          src="/fiels.svg" 
      ...
      <div className="absolute inset-0 p-8 flex flex-col">
        ...
        <div className="border-t border-white/50 pt-4">
          <div className="flex justify-start">
            <img src="/mora.svg" alt="" className="w-30 h-26" />
          </div>
        </div>
      </div>
    </div>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-start justify-between mb-8 md:mb-12">
            <h2 className="text-5xl md:text-8xl font-bold mb-4 md:mb-0">
              Featured Minerals
            </h2>
            <p className="text-lg w-full md:max-w-md">
              Discover our diverse range of high-quality minerals extracted and
              processed with sustainable practices and cutting-edge technology.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="bg-white text-black p-8">
                  ...
                  <p className="text-gray-500/90">
                    High-purity gold extracted using sustainable methods from
                    our Ethiopian mines.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="bg-white text-black p-8">
                  ...
                  <p className="text-gray-500/90">
                    Premium white kaolin clay with excellent purity and
                    consistency.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="bg-white text-black p-8">
                  ...
                  <p className="text-gray-500/90">
                    Pure dolomite with excellent chemical properties for various
                    industries.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 md:p-12 relative z-10">
                ...
                <p className="text-gray-300 mb-8 text-sm md:text-base">
                  Our advanced laboratory facilities offer comprehensive testing
                  and analysis services for the mining industry. With
                  cutting-edge equipment and experienced professionals, we
                  deliver accurate and reliable results for all your mineral
                  testing needs.
                </p>
                ...
                <div className="flex flex-wrap md:flex-nowrap gap-4 mb-8">
                  ...
                  <button className="flex items-center gap-2 border border-white rounded-full px-8 py-2 hover:bg-white/10 transition-colors">
                    <svg
                      width="27"
                      height="21"
                      viewBox="0 0 27 18"
                    ...
                    >
                      <path
                        d="M8.59375 1.64355C8.96875 0.893555 10.0312 0.924805 10.375 1.64355L12.4375 5.7998L17 6.45605C17.8125 6.58105 18.125 7.58105 17.5312 8.1748L14.25 11.3936L15.0312 15.9248C15.1562 16.7373 14.2812 17.3623 13.5625 16.9873L9.5 14.8311L5.40625 16.9873C4.6875 17.3623 3.8125 16.7373 3.9375 15.9248L4.71875 11.3936L1.4375 8.1748C0.84375 7.58105 1.15625 6.58105 1.96875 6.45605L6.5625 5.7998L8.59375 1.64355Z"
                        fill="#F0F0F0"
                      />
                    </svg>
