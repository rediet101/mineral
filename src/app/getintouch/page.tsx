    ...
    <section className="relative w-full h-[700px] overflow-hidden">
      ...
      <div className="container mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className=" text-white rounded-3xl p-12 relative overflow-hidden">
            <div 
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Emergency: +251 91 234 5678</p>
                </div>

                <div>
                  <h3 className="font-bold mb-2">Email</h3>
                  <p className="text-gray-300">info@ethiopianmineral.com</p>
                  <p className="text-gray-300">support@ethiopianmineral.com</p>
                </div>
